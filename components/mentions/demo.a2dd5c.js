...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var N=c(0),G=c(46);function h(l){return h=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(a){return typeof a}:function(a){return a&&typeof Symbol=="function"&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},h(l)}var m=A(c(0)),S=c(12);function O(l){if(typeof WeakMap!="function")return null;var a=new WeakMap,n=new WeakMap;return(O=function(e){return e?n:a})(l)}function A(l,a){if(!a&&l&&l.__esModule)return l;if(l===null||h(l)!=="object"&&typeof l!="function")return{default:l};var n=O(a);if(n&&n.has(l))return n.get(l);var p={},e=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var r in l)if(r!=="default"&&Object.prototype.hasOwnProperty.call(l,r)){var g=e?Object.getOwnPropertyDescriptor(l,r):null;g&&(g.get||g.set)?Object.defineProperty(p,r,g):p[r]=l[r]}return p.default=l,n&&n.set(l,p),p}function w(l,a){return B(l)||T(l,a)||F(l,a)||z()}function z(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
