...
`}},4419:function(h,w,p){h.exports={content:{"zh-CN":[["p","\u4FEE\u6539\u5185\u5BB9\u524D\uFF0C\u8BF7\u5C1D\u8BD5\u6B64 Demo \u67E5\u770B\u6837\u5F0F\u662F\u5426\u6296\u52A8\u3002"],["pre",{lang:"tsx",highlighted:`import {
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var x=p(0),E=p(42);function o(t){return o=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(c){return typeof c}:function(c){return c&&typeof Symbol=="function"&&c.constructor===Symbol&&c!==Symbol.prototype?"symbol":typeof c},o(t)}w.default=void 0;var n=p(61),a=p(13),e=f(p(0));function d(t){if(typeof WeakMap!="function")return null;var c=new WeakMap,s=new WeakMap;return(d=function(u){return u?s:c})(t)}function f(t,c){if(!c&&t&&t.__esModule)return t;if(t===null||o(t)!="object"&&typeof t!="function")return{default:t};var s=d(c);if(s&&s.has(t))return s.get(t);var l={__proto__:null},u=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var i in t)if(i!=="default"&&Object.prototype.hasOwnProperty.call(t,i)){var v=u?Object.getOwnPropertyDescriptor(t,i):null;v&&(v.get||v.set)?Object.defineProperty(l,i,v):l[i]=t[i]}return l.default=t,s&&s.set(t,l),l}function b(t,c){return r(t)||C(t,c)||g(t,c)||A()}function A(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
