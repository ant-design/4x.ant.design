...
`}},4391:function(v,N,p){v.exports={content:{"zh-CN":[["p","\u4FEE\u6539\u5185\u5BB9\u524D\uFF0C\u8BF7\u5C1D\u8BD5\u6B64 Demo \u67E5\u770B\u6837\u5F0F\u662F\u5426\u6296\u52A8\u3002"],["pre",{lang:"tsx",highlighted:`import {
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var x=p(0),E=p(50);function o(t){return o=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(c){return typeof c}:function(c){return c&&typeof Symbol=="function"&&c.constructor===Symbol&&c!==Symbol.prototype?"symbol":typeof c},o(t)}var n=p(60),a=p(12),e=f(p(0));function d(t){if(typeof WeakMap!="function")return null;var c=new WeakMap,s=new WeakMap;return(d=function(k){return k?s:c})(t)}function f(t,c){if(!c&&t&&t.__esModule)return t;if(t===null||o(t)!=="object"&&typeof t!="function")return{default:t};var s=d(c);if(s&&s.has(t))return s.get(t);var l={},k=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var i in t)if(i!=="default"&&Object.prototype.hasOwnProperty.call(t,i)){var w=k?Object.getOwnPropertyDescriptor(t,i):null;w&&(w.get||w.set)?Object.defineProperty(l,i,w):l[i]=t[i]}return l.default=t,s&&s.set(t,l),l}function b(t,c){return r(t)||h(t,c)||g(t,c)||C()}function C(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function g(t,c){if(!!t){if(typeof t=="string")return y(t,c);var s=Object.prototype.toString.call(t).slice(8,-1);if(s==="Object"&&t.constructor&&(s=t.constructor.name),s==="Map"||s==="Set")return Array.from(t);if(s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s))return y(t,c)}}function y(t,c){(c==null||c>t.length)&&(c=t.length);for(var s=0,l=new Array(c);s<c;s++)l[s]=t[s];return l}function h(t,c){var s=t==null?null:typeof Symbol!="undefined"&&t[Symbol.iterator]||t["@@iterator"];if(s!=null){var l=[],k=!0,i=!1,w,L;try{for(s=s.call(t);!(k=(w=s.next()).done)&&(l.push(w.value),!(c&&l.length===c));k=!0);}catch(A){i=!0,L=A}finally{try{!k&&s.return!=null&&s.return()}finally{if(i)throw L}}return l}}function r(t){if(Array.isArray(t))return t}var m=a.Layout.Header,S=a.Layout.Sider,F=a.Layout.Content,B=[{key:"1",icon:e.default.createElement(n.PieChartOutlined,null),label:"Option 1"},{key:"2",icon:e.default.createElement(n.DesktopOutlined,null),label:"Option 2"},{key:"sub1",icon:e.default.createElement(n.UserOutlined,null),label:"User",children:[{key:"3",label:"Tom"},{key:"4",label:"Bill"},{key:"5",label:"Alex"}]},{key:"sub2",icon:e.default.createElement(n.TeamOutlined,null),label:"Team",children:[{key:"6",label:"Team 1"},{key:"7",label:"Team 2"}]},{key:"9",icon:e.default.createElement(n.FileOutlined,null)}],O=function(){var c=(0,e.useState)(!0),s=b(c,2),l=s[0],k=s[1];return e.default.createElement(a.Layout,null,e.default.createElement(S,{trigger:null,collapsible:!0,collapsed:l},e.default.createElement("div",{className:"logo"}),e.default.createElement(a.Menu,{theme:"dark",mode:"inline",defaultSelectedKeys:["3"],defaultOpenKeys:["sub1"],items:B})),e.default.createElement(a.Layout,null,e.default.createElement(m,{className:"site-layout-background",style:{padding:0}},e.default.createElement(l?n.MenuUnfoldOutlined:n.MenuFoldOutlined,{className:"trigger",onClick:function(){return k(!l)}})),e.default.createElement(F,{className:"site-layout-background",style:{margin:"24px 16px",padding:24,minHeight:280}},"Content")))},u=O;return x.createElement(u)},style:`#components-layout-demo-custom-trigger .trigger {
  padding: 0 24px;
  font-size: 18px;
  line-height: 64px;
  cursor: pointer;
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var x=p(0),E=p(50);function o(s){return o=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(l){return typeof l}:function(l){return l&&typeof Symbol=="function"&&l.constructor===Symbol&&l!==Symbol.prototype?"symbol":typeof l},o(s)}var n=p(60),a=p(12),e=f(p(0));function d(s){if(typeof WeakMap!="function")return null;var l=new WeakMap,k=new WeakMap;return(d=function(w){return w?k:l})(s)}function f(s,l){if(!l&&s&&s.__esModule)return s;if(s===null||o(s)!=="object"&&typeof s!="function")return{default:s};var k=d(l);if(k&&k.has(s))return k.get(s);var i={},w=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var L in s)if(L!=="default"&&Object.prototype.hasOwnProperty.call(s,L)){var A=w?Object.getOwnPropertyDescriptor(s,L):null;A&&(A.get||A.set)?Object.defineProperty(i,L,A):i[L]=s[L]}return i.default=s,k&&k.set(s,i),i}function b(s,l){return r(s)||h(s,l)||g(s,l)||C()}function C(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function g(s,l){if(!!s){if(typeof s=="string")return y(s,l);var k=Object.prototype.toString.call(s).slice(8,-1);if(k==="Object"&&s.constructor&&(k=s.constructor.name),k==="Map"||k==="Set")return Array.from(s);if(k==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(k))return y(s,l)}}function y(s,l){(l==null||l>s.length)&&(l=s.length);for(var k=0,i=new Array(l);k<l;k++)i[k]=s[k];return i}function h(s,l){var k=s==null?null:typeof Symbol!="undefined"&&s[Symbol.iterator]||s["@@iterator"];if(k!=null){var i=[],w=!0,L=!1,A,U;try{for(k=k.call(s);!(w=(A=k.next()).done)&&(i.push(A.value),!(l&&i.length===l));w=!0);}catch(M){L=!0,U=M}finally{try{!w&&k.return!=null&&k.return()}finally{if(L)throw U}}return i}}function r(s){if(Array.isArray(s))return s}var m=a.Layout.Header,S=a.Layout.Content,F=a.Layout.Footer,B=a.Layout.Sider;function O(s,l,k,i){return{key:l,icon:k,children:i,label:s}}var u=[O("Option 1","1",e.default.createElement(n.PieChartOutlined,null)),O("Option 2","2",e.default.createElement(n.DesktopOutlined,null)),O("User","sub1",e.default.createElement(n.UserOutlined,null),[O("Tom","3"),O("Bill","4"),O("Alex","5")]),O("Team","sub2",e.default.createElement(n.TeamOutlined,null),[O("Team 1","6"),O("Team 2","8")]),O("Files","9",e.default.createElement(n.FileOutlined,null))],t=function(){var l=(0,e.useState)(!1),k=b(l,2),i=k[0],w=k[1];return e.default.createElement(a.Layout,{style:{minHeight:"100vh"}},e.default.createElement(B,{collapsible:!0,collapsed:i,onCollapse:function(A){return w(A)}},e.default.createElement("div",{className:"logo"}),e.default.createElement(a.Menu,{theme:"dark",defaultSelectedKeys:["1"],mode:"inline",items:u})),e.default.createElement(a.Layout,{className:"site-layout"},e.default.createElement(m,{className:"site-layout-background",style:{padding:0}}),e.default.createElement(S,{style:{margin:"0 16px"}},e.default.createElement(a.Breadcrumb,{style:{margin:"16px 0"}},e.default.createElement(a.Breadcrumb.Item,null,"User"),e.default.createElement(a.Breadcrumb.Item,null,"Bill")),e.default.createElement("div",{className:"site-layout-background",style:{padding:24,minHeight:360}},"Bill is a cat.")),e.default.createElement(F,{style:{textAlign:"center"}},"Ant Design \xA92018 Created by Ant UED")))},c=t;return x.createElement(c)},style:`#components-layout-demo-side .logo {
  height: 32px;
  margin: 16px;
  background: rgba(255, 255, 255, 0.3);
}
